...
# C++ 코드 컴파일
sourceCpp("my_LSIRM_4layered_nonhierarchical_v5.cpp")

lsirm_sharedpos_layer4_robust_cpp <- function(
  ...
  # --- Run C++ MCMC ---
  cat("Running C++ MCMC (4-layered, robust continuous, nu2 =", nu2, ")...\n")
  ...
  res$info <- list(n=n, P1=P1, P2=P2, P3=P3, P4=P4, K=K, nu2=nu2)
  return(res)
}
