...
// =========================================================
// v11t: Joint multilayered LSIRM + t-MIXTURE clustering
...
// =========================================================
// Main MCMC (v11t: t-mixture)
// =========================================================
// [[Rcpp::export]]
List run_lsirm_fmc_v11t_cpp(
  ...
  for (int iter = 0; iter < n_iter; ++iter) {
    ...
    for (int j = 0; j < P1; ++j) {
      ...
      double q_old = mix_quad(b_old,  cl);
      double q_new = mix_quad(b_prop, cl);
      if (log(R::runif(0,1)) <
          (ll_f(b_prop) - 0.5 * ws[q] * q_new -
           (ll_f(b_old) - 0.5 * ws[q] * q_old))) {
