...
// =========================================================
// Main MCMC Function (5-layered: bin, con(robust), cnt, ord1, ord2)
// =========================================================
// [[Rcpp::export]]
List run_lsirm_v4_cpp(
  ...
  mat lambda2(n, P2, fill::ones);  // initialize all to 1
  ...
  cube store_lambda2(n, P2, n_save);       // full per-iteration snapshots
  mat  sum_lambda2(n, P2, fill::zeros);    // running sum for posterior mean
