...
# C++ 코드 컴파일
sourceCpp("data/my_LSIRM_5layered_nonhierarchical_v4.cpp")

lsirm_sharedpos_layer5_robust_cpp <- function(
  ...
  # --- Run C++ MCMC ---
  cat("Running C++ MCMC (5-layered, robust continuous, nu2 =", nu2, ")...\n")
  res <- run_lsirm_v4_cpp(
    Y_bin, Y_con, Y_cnt, Y_ord1, Y_ord2,
